  ...
  if (open) {
    return (
      <>
        ...
        <dialog open={open} class="layout-center p-6 border-solid border-1 border-color-primary bg-primary w-full">
          <form onSubmit={handleSubmit} class="layout-stack-4">
            <label class="flex-column layout-stack-1">
              <span class="text-secondary text-small">Board title</span>
              <input
