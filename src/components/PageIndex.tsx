    ...
    <div class="px-3">
      <div class="layout-center overflow-hidden w-full layout-stack-8">
        <div class="overflow-hidden">
          ...
          <div>
            <BoardFormDialog open={dialogOpen} handleClickMask={handleClickMouse} addBoard={addBoard} />
          </div>
          ...
          <div>
            ...
            {storageDataSize >= 0 && (
              <div class="py-2">
                ...
                <progress max={STORAGE_LIMIT} value={storageDataSize} class="pattern-progress w-full h-4"></progress>
              </div>
            )}
          </div>
        </div>
